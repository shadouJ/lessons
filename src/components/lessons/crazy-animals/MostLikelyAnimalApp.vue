<template>
	<div class="app--container container mt-4 mb-5">
		...
		<div class="app--animals-table mt-3">
			<h5 class="text-success text-center">{{ trialNumber }} trials in total - {{ triedNumber }} tried</h5>
			<div class="app--animal-list">
				<div
					class="app--animal-item" 
					v-for="(item, index) in allAnimals"
					:key="index"
				>
					<h4>{{ item.animal }}
		...
		<div class="text-center mt-4 mb-1">
			<div v-if="!isStart">
				<span class="badge badge-danger">
					Change the number of animals or
				</span>
			</div>
			<div v-if="isFinish">
				<span class="badge badge-danger">
...
export default {
	...
	methods: {
		generateAnimals() {	// Generate all animals with different combinations
			this.allAnimals = [];
