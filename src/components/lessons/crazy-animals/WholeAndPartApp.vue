	...
	<div class="container mt-4 mb-5">
		...
		<div class="app--animal-parts text-center mt-4">
			...
			<h5 class="text-center">
				{{ trialNumber }} with {{ numberOfAnimals }} animals
			</h5>
			<h5 class="text-center">
				{{ count }} so far
			</h5>
		...
		<div class="app--action text-center">
			<div><span v-if="!isStart" class="badge badge-danger mb-1">
				Change the number of animals or	
			</span> 
				<span v-if="isFinish" class="badge badge-danger mb-1">
					Finished
				</span>
			</div>
			<button 
...
export default {
	...
	methods: {
		handleNextAnimal() {
			...
			let giraffePart = 0; let horsePart = 0; let duckPart = 0;
