                            ...
                            <div class="app--lesson-action">
                                <div @change="remeberWords" ref="dropzone">
                                    <div class="row" style="margin-bottom: 15px">
                                        ...
                                        <div ref="drag1"  id="dragID1" class="drag-drop" ><label for="input" class="inp"><input type="text" ref="input" minlength="1" id="input" placeholder="Team Name" v-model="input1" v-bind:disabled="dataDisabled" ></label></div>
                                    </div>

                                    <div class="row" style="margin-bottom: 15px">
                                        <span style="font-size: 115%;display: inline-block;width: 30px" class="badge badge-secondary"  ref="span2">2</span>
                                        <div ref="drag2" id="dragID2" class="drag-drop"><label for="input2" class="inp"><input type="text" ref="input2" minlength="1" id="input2" placeholder="Team Name" v-model="input2" v-bind:disabled="dataDisabled"></label></div>
                                    </div>
                                    <div class="row" style="margin-bottom: 15px">
                                        <span style="font-size: 115%;display: inline-block;width: 30px" class="badge badge-success"  ref="span3">3</span>
                                        <div ref="drag3" id="dragID3" class="drag-drop" ><label for="input3" class="inp"><input type="text" ref="input3" minlength="1" id="input3" placeholder="Team Name" v-model="input3" v-bind:disabled="dataDisabled"></label></div>
                                    </div>
                                    <div class="row" style="margin-bottom: 15px">
                                        <span style="font-size: 115%;display: inline-block;width: 30px" class="badge badge-secondary"  ref="span4">4</span>
                                        <div ref="drag4" id="dragID4" class="drag-drop"><label for="input4" class="inp"><input type="text" ref="input4" minlength="1" id="input4" placeholder="Team Name" v-model="input4" v-bind:disabled="dataDisabled"></label></div>
                                    </div>
                                    <div class="row" style="margin-bottom: 15px">
                                        <span style="font-size: 115%;display: inline-block;width: 30px" class="badge badge-success"  ref="span5">5</span>
                                        <div ref="drag5" id="dragID5" class="drag-drop"><label for="input5" class="inp"><input type="text" ref="input5" minlength="1" id="input5" placeholder="Team Name" v-model="input5" v-bind:disabled="dataDisabled"></label></div>
                                    </div>
                                    <div class="row" style="margin-bottom: 15px">
                                        <span style="font-size: 115%;display: inline-block;width: 30px" class="badge badge-secondary"  ref="span6">6</span>
                                        <div ref="drag6" id="dragID6" class="drag-drop"><label for="input6" class="inp"><input type="text" ref="input6" minlength="1" id="input6" placeholder="Team Name" v-model="input6" v-bind:disabled="dataDisabled"></label></div>
                                    </div>
                                    <div class="row" style="margin-bottom: 15px">
                                        <span style="font-size: 115%;display: inline-block;width: 30px" class="badge badge-success" ref="span7">7</span>
                                        <div ref="drag7" id="dragID7" class="drag-drop"><label for="input7" class="inp"><input type="text" ref="input7" minlength="1" id="input7" placeholder="Team Name" v-model="input7" v-bind:disabled="dataDisabled"></label></div>
                                    </div>
                                    <div class="row"  style="margin-bottom: 15px">
                                        <span style="font-size: 115%;display: inline-block;width: 30px" class="badge badge-secondary" ref="span8">8</span>
                                        <div ref="drag8" id="dragID8" class="drag-drop"><label for="input8" class="inp"><input type="text" ref="input8" minlength="1" id="input8" placeholder="Team Name" v-model="input8" v-bind:disabled="dataDisabled">
                                    ...
                                    <div class="row"  style="margin-bottom: 15px" v-if="minus">
                                        ...
                                        <div ref="drag9" id="dragID9"  class="drag-drop"><label for="input9" class="inp"><input type="text" ref="input9" minlength="1" id="input9" placeholder="Team Name" v-model="input9" v-bind:disabled="dataDisabled">
                                    ...
                                    <div class="row"  style="margin-bottom: 15px" v-if="minus2">
                                        ...
                                        <div ref="drag10" id="dragID10" class="drag-drop"><label for="input10" class="inp"><input type="text" ref="input10" minlength="1" id="input10" placeholder="Team Name" v-model="input10" v-bind:disabled="dataDisabled">
                                    ...
                                    <div class="row"  style="margin-bottom: 15px" v-if="minus3">
                                        ...
                                        <div ref="drag11" id="dragID11" class="drag-drop"><label for="input11" class="inp"><input type="text" ref="input11" minlength="1" id="input11" placeholder="Team Name" v-model="input11" v-bind:disabled="dataDisabled">
                                    ...
                                    <div class="row"  style="margin-bottom: 15px" v-if="minus4">
                                        ...
                                        <div ref="drag12" id="dragID12" class="drag-drop"><label for="input12" class="inp"><input type="text" ref="input12" minlength="1" id="input12" placeholder="Team Name" v-model="input12" v-bind:disabled="dataDisabled">
                                    ...
                                    <div class="row"  style="margin-bottom: 15px" v-if="minus5">
                                        ...
                                        <div ref="drag13" id="dragID13" class="drag-drop"><label for="input13" class="inp"><input type="text" ref="input13" minlength="1" id="input13" placeholder="Team Name" v-model="input13" v-bind:disabled="dataDisabled">
                                    ...
                                    <div class="row"  style="margin-bottom: 15px" v-if="minus6">
                                        ...
                                        <div ref="drag14" id="dragID14" class="drag-drop"><label for="input14" class="inp"><input type="text" ref="input14" minlength="1" id="input14" placeholder="Team Name" v-model="input14" v-bind:disabled="dataDisabled">
                                    ...
                                    <div class="row"  style="margin-bottom: 15px" v-if="minus7">
                                        ...
                                        <div ref="drag15" id="dragID15" class="drag-drop"><label for="input15" class="inp"><input type="text" ref="input15" minlength="1" id="input15" placeholder="Team Name" v-model="input15" v-bind:disabled="dataDisabled">
                                    ...
                                    <div class="row"  style="margin-bottom: 15px" v-if="minus8">
                                        ...
                                        <div ref="drag16" id="dragID16" class="drag-drop"><label for="input16" class="inp"><input type="text" ref="input16" minlength="1" id="input16" placeholder="Team Name" v-model="input16" v-bind:disabled="dataDisabled">
                                    ...
                                    <div class="row"  style="margin-bottom: 15px" v-if="minus9">
                                        ...
                                        <div ref="drag17" id="dragID17" class="drag-drop"><label for="input17" class="inp"><input type="text" ref="input17" minlength="1" id="input17" placeholder="Team Name" v-model="input17" v-bind:disabled="dataDisabled">
                                    ...
                                    <div class="row"  style="margin-bottom: 15px" v-if="minus10">
                                        ...
                                        <div ref="drag18" id="dragID18" class="drag-drop"><label for="input18" class="inp"><input type="text" ref="input18" minlength="1" id="input18" placeholder="Team Name" v-model="input18" v-bind:disabled="dataDisabled">
                                        </label></div>
                                    </div>
