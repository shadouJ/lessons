		...
		<div class="row">
					...
					<div class="app--building-option-view">
						<div class="form-check form-check-inline">
							<input 
								...
								:disabled="!isStart">
							<label for="front-view" class="form-check-label">
								Front View
							</label>
						</div>
						<div class="form-check form-check-inline">
							<input 
								...
								v-model="viewDirection"
								:disabled="!isStart">
							<label for="back-view" class="form-check-label">
								Back View
							</label>
						</div>
						<div class="form-check form-check-inline">
							<input 
								...
								v-model="viewDirection"
								:disabled="!isStart">
							<label for="left-view" class="form-check-label">
								Left View
							</label>
						</div>
						<div class="form-check form-check-inline">
							<input 
								...
								v-model="viewDirection"
								:disabled="!isStart">
							<label for="right-view" class="form-check-label">
								Right View
							</label>
						</div>
					</div>			
			...
			<div class="col-12 col-md-4 col-lg-5">
				...
				<div class="app--action text-center mt-4">
					<button v-if="!isStart" class="btn btn-outline-success" @click="handleStartBuilding">
						Start
					</button>
					<button v-if="isStart" class="btn btn-outline-success" @click="handleCheckBuilding">
						Check
					</button>
					<button v-if="isStart" class="btn btn-outline-dark" @click="handleSeeAnswer">
						Answer
					</button>
				</div>
			</div>
	...
	methods: {
		...
		createBuilding() {
			...
			for(let i = 0; i < this.gridSize; i++) {
				...
				for(let j = 0; j < this.gridSize; j++) {
					this.buildingArray[i][j] = pickNumber(this.includeOpenSpace ? 0 : 1, 9);
					this.checkBuildingArray[i][j] = -1;
				}
			}
		...
		setDraggable() {
			interact('.app--number-blocks-container .app--number-draggable').draggable({
				inertia: false,
		...
		handleOnDrop(e) {
			...
			this.answerBuildingArray[arrX][arrY] = Number(e.relatedTarget.innerText.trim());
