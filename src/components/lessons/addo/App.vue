<template>
  <div>
    <div v-if="selectedOption===-1">
      <app-title-static>Addo</app-title-static>
    ...
    <div class="container-fluid" v-else>
      <transition appear appear-class="lesson-appear" appear-active-class="lesson-appear-active">
        <app-top-nav @backToMenu="selectedOption = $event">Addo</app-top-nav>
      </transition>
...
export default {
  ...
  data: function() {
    return {
      options: [
        { id: 1, title: "Play a game of Addo" },
        { id: 2, title: "Comparing grids: Many games" },
        { id: 3, title: "Build an addition table" },
